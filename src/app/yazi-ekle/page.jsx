...
import { createBlogAction } from "@/store/actionCreators";
import Card from "@/components/card";
import InputField from "@/components/form/InputField";
import SubmitButton from "@/components/form/SubmitButton";
import { convertToUrl, generateUniqueID } from "@/utils/helpers";
...
function AddBlog() {
  ...
  const requiredFields = ["title", "date", "content", "image", "publish"];
  ...
  const handleSubmit = async (e) => {
    ...
    if (formData.image !== "") {
      ...
      dispatch(createBlogAction(data));
    } else {
